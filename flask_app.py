...
def login():
    ...
    current_feature_name = request.values.get("feature_name")
       # current_feature_name = current_feature_name[2:]
       # current_feature_name = current_feature_name[:-3]

    mycursor.execute("SELECT * FROM Headache WHERE user = %s", ('Jocelyn',))
